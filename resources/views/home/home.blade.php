            ...
            <table class="table table-striped table-sm">
                ...
                @foreach($themes as $theme)
                    <tr>
                        ...
                        <td><a href="{{ route('makeBackup', [$theme['id'], $theme['name']])}}" class="btn btn-warning"
                            >Make backup</a></td>
                    </tr>
                @endforeach
                </tbody>
            ...
            <table class="table table-striped table-sm">
                ...
                @foreach($backups as $backup)
                    <tr>
                        ...
                        <td><a href="{{ route('deleteBackup', $backup) }}" class="btn btn-danger">Delete backup</a></td>
                        <td><a href="{{ route('restoreBackup', $backup) }}" class="btn btn-warning">Restore backup</a>
                        </td>
                    </tr>
                @endforeach
                </tbody>
            ...
            <table class="table table-striped table-sm">
                ...
                @foreach($schedules as $schedule)
                    <tr>
                        ...
                        <td><a href="{{ route('deleteSchedule', $schedule['id']) }}" class="btn btn-danger">
                                Delete schedule</a></td>
                    </tr>
                @endforeach
                </tbody>
            </table>
